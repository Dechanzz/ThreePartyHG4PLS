...
g=legend('$\xi_n=5$', '$\xi_n=7$', '$\xi_n=9$', '$\xi_n=11$', '$\xi_n=13$','$\xi_n=15$');
h = xlabel('Time Slots (0.5s)','FontSize',16); ylabel('Cumulative Utility of LUs','FontSize',16);
